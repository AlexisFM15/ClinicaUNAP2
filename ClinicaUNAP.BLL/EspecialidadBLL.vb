...
Public Class EspecialidadBLL
    ...
    Public Shared Sub Save(especialidad As EspecialidadEntity) 'Se crea una variable la contendra los objetos entities del cual deseemos tener
        ...
        If especialidad.IdEspecialidad = 0 Then

            'es una nueva

            EspecialidadDAL.Create(especialidad)
        Else

            'es una actualizacion

            EspecialidadDAL.Update(especialidad)
        End If
    ...
    Public Shared Function GetById(id As Integer) As EspecialidadEntity
        ...
        Return EspecialidadDAL.GetByID(id)
