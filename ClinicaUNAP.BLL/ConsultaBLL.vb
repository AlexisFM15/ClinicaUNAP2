...
Public Class ConsultaBLL
    ...
    Public Shared Sub Save(Consulta As ConsultaEntity) 'Se crea una variable la contendra los objetos entities del cual deseemos tener
        ...
        If Consulta.IdConsulta = 0 Then
            ...
            ConsultaDAL.Create(Consulta)
        Else

            'es una actualizacion

            ConsultaDAL.Update(Consulta)
        End If
