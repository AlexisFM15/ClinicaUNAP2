...
Public Class UsuarioBLL
    ...
    Public Shared Sub Save(usuario As UsuarioEntity) 'Se crea una variable la contendra los objetos entities del cual deseemos tener
    ...
    Public Shared Function GetByValor(valor As String) As List(Of UsuarioEntity)
        ...
        Return UsuarioDAL.GetByValor(valor)
