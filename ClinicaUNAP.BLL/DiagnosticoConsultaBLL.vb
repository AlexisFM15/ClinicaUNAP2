...
Public Class DiagnosticoConsultaBLL
    ...
    Public Shared Sub Save(DiagnosticoConsulta As DiagnosticoConsultaEntity) 'Se crea una variable la contendra los objetos entities del cual deseemos tener
        ...
        If DiagnosticoConsulta.IdDiagnosticoConsulta = 0 Then

            'es una nueva

            DiagnosticoConsultaDAL.Create(DiagnosticoConsulta)
        Else

            'es una actualizacion

            DiagnosticoConsultaDAL.Update(DiagnosticoConsulta)
        End If
    ...
    Public Shared Function GetById(id As Integer) As DiagnosticoConsultaEntity
        ...
        Return DiagnosticoConsultaDAL.GetByID(id)
