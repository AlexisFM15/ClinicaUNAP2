...
Public Class EmpleadoBLL
    ...
    Public Shared Sub Save(empleado As EmpleadoEntity) 'Se crea una variable la contendra los objetos entities del cual deseemos tener
    ...
    Public Shared Function GetByValor(valor As String) As List(Of EmpleadoEntity)
        ...
        Return EmpleadoDAL.GetByValor(valor)
