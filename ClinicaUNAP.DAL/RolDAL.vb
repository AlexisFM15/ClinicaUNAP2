...
Public Class RolDAL
    ...
    Public Shared Sub Create(rol As RolEntity)
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "INSERT INTO Rol ( Nombre) Values (@nombre ) SELECT SCOPE_IDENTITY()"
    ...
    Public Shared Sub Update(rol As RolEntity)
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "UPDATE Rol Set Nombre = @nombre WHERE IdRol = @idRol"
    ...
    Public Shared Function Delete(id As Integer) As Boolean
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "DELETE FROM Rol WHERE IdRol"
    ...
    Private Shared Function ConvertToObject(reader As IDataReader) As RolEntity
        ...
        rol.Nombre = reader("Nombre")



        'Se retorna la conversion

        Return rol 'La variable instanciada
    ...
    Public Shared Function GetByValor(valor As String) As List(Of RolEntity)
        ...
        Dim list As New List(Of RolEntity)
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "SELECT * FROM Rol WHERE Nombre Like '%'+ @Valor +'%'  ORDER BY Nombre"
    ...
    Public Shared Function GetAll() As List(Of RolEntity)
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "SELECT * FROM Rol  ORDER BY Nombre"
    ...
    Public Shared Function GetByID(id As Integer) As RolEntity
        ...
        Using conex As New SqlConnection(m_CadenaConexion)
            ...
            Dim sql As String = "SELECT * FROM Rol Where IdRol = @idRol"
